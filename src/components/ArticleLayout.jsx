...
export default function ArticleLayout({
  ...
  // Получаем slug из meta или из URL
  const slug = meta.slug || (breadcrumbs[breadcrumbs.length - 1]?.href?.split('/').pop()) || 'article';
